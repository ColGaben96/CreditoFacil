		...
		try 
		{
			...
			if(evento.getActionCommand() == gui.getPbarra().GUARDAR)
			{
				...
				if(bd.getA().getCred() == null)
				{
					 ...
					 */
					bd.getA().saveCredAs(gui.getPGrande().getPclientes().getTxCliente().getText() +"\n"
							+ gui.getPGrande().getPclientes().getlTipoDocumento2().getSelectedItem().toString() +"\n"
							+ gui.getPGrande().getPclientes().getTxDocumento().getText()+"\n"
							+ gui.getPGrande().getPclientes().getTxMonto().getText()+"\n"
							+ gui.getPGrande().getPclientes().getTxPlazo().getText()+"\n"
							+ gui.getPGrande().getPclientes().getTxInteres().getText()+"\n"
							+ gui.getPGrande().getPclientes().getTxTasaEfectiva().getText()+"\n"
							+ gui.getPGrande().getPclientes().getTxValorAnual().getText()+"\n"
							+ gui.getPGrande().getPclientes().getTxCuota().getText()+"\n");
					gui.setTitle("CreditoFacil - "+bd.getA().getCred());
				}
				else
				{
					 ...
					 */
					bd.getA().saveCred(gui.getPGrande().getPclientes().getTxCliente().getText() +"\n"
							+ gui.getPGrande().getPclientes().getlTipoDocumento2().getSelectedItem().toString() +"\n"
							+ gui.getPGrande().getPclientes().getTxDocumento().getText()+"\n"
							+ gui.getPGrande().getPclientes().getTxMonto().getText()+"\n"
							+ gui.getPGrande().getPclientes().getTxPlazo().getText()+"\n"
			...
			if(evento.getActionCommand().equals(gui.getPGrande().getPclientes().COTIZAR))
			{
				...
				gui.getPGrande().getPtabla().setFilas(bd.getCredit().plazo());
